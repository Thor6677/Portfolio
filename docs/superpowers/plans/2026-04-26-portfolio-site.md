...
**Tech Stack:** Astro 6 (static output), plain CSS custom properties, Astro Content Collections for blog, nginx:alpine Docker container, Cloudflare proxy + existing origin cert for TLS.
